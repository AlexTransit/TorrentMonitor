...
| `path` | нет | директория для скачивания только для этой темы; если пусто — общая из настроек |
| `category` | нет | категория qBittorrent только для этой темы; если пусто — «Категория по умолчанию» из настроек |
...
| `path` | нет | директория для скачивания только для этой темы; если пусто — общая из настроек |
| `category` | нет | категория qBittorrent только для этого сериала; если пусто — «Категория по умолчанию» из настроек |
